      ...
      <header className="sticky top-0 z-50 -mx-4 px-4 glass border-b border-slate-200/50">
        <div className="app-max py-4 flex items-center justify-between">
          <button 
            ...
            className="btn btn-ghost flex items-center gap-2 text-purple-600 py-2 px-3 min-h-0"
          >
      ...
      <main className="app-max py-6 space-y-4">
            ...
            <div className="space-y-2">
              {drillSergeantThoughts.map((thought) => (
                <button
                  ...
                  className="surface card-hover w-full p-4 text-left bg-rose-50/50 border-rose-200/50 hover:bg-rose-100/50"
                >
        ...
        {currentStep === 'reframe' && (
          <div className="space-y-4">
            {/* The harsh thought */}
            <div className="surface p-5 bg-rose-50/80 border-rose-200/50">
            ...
            <section className="surface p-6">
              ...
              <div className="surface p-5 bg-green-50/80 border-green-200/50 mb-4">
              ...
              <div className="surface p-4 bg-purple-50/80 border-purple-200/50 text-center mb-5">
        ...
        {currentStep === 'action' && (
          <section className="surface p-6 space-y-5">
            ...
            {/* Custom */}
            <div className="surface p-4" style={{ borderStyle: 'dashed' }}>
              <input
                type="text"
                value={customAction}
